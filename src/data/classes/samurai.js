...
export const SAMURAI = {
  ...
  combat_start_tags: [],
  starting_cards: ['heavy_slice', 'flame_strike', 'storm_strike', 'quick_steps', 'stream_slash', 'still_wind', 'steel_will', 'mend', 'speed_up',  'battojutsu', 'freeze_slash', 'stream_slash'],
  // 
  cards: SAMURAI_CARDS,
