...
export { default as Snowy_Forest }       from './MAP_ICONS_2/Snowy_Forest.png';
export { default as Green_Tree_At_Snow } from './MAP_ICONS_2/Green_Tree_At_Snow.png';
export { default as Big_Snow_Cave }      from './MAP_ICONS_2/Big_Snow_Cave.png';
export { default as Big_Snow_Cave_2 }    from './MAP_ICONS_2/Big_Snow_Cave_2.png';
export { default as Home }               from './MAP_ICONS_2/Home.png';
export { default as Snow_Cherry_Path_1 } from './MAP_ICONS_2/Snow_Cherry_Path_1.png';
export { default as Snow_Field_Path_1 }  from './MAP_ICONS_2/Snow_Field_Path_1.png';
export { default as Snow_Field_Path_2 }  from './MAP_ICONS_2/Snow_Field_Path_2.png';
export { default as Snow_Field_Path_3 }  from './MAP_ICONS_2/Snow_Field_Path_3.png';
export { default as Snow_Field_Shrine }  from './MAP_ICONS_2/Snow_Field_Shrine.png';
export { default as Snow_Iron_Gate }     from './MAP_ICONS_2/Snow_Iron_Gate.png';
export { default as Snow_Mountain_1 }    from './MAP_ICONS_2/Snow_Mountain_1.png';
export { default as Snow_Mountain_2 }    from './MAP_ICONS_2/Snow_Mountain_2.png';
export { default as Snow_and_Water }     from './MAP_ICONS_2/Snow_and_Water.png';
export { default as Snow_and_Water_2 }   from './MAP_ICONS_2/Snow_and_Water_2.png';
export { default as Snowy_Field_Bamboo } from './MAP_ICONS_2/Snowy_Field_Bamboo.png';
export { default as Snowy_Field_Den }    from './MAP_ICONS_2/Snowy_Field_Den.png';
export { default as Sunset }             from './MAP_ICONS_2/Sunset.png';
export { default as Sunset_2 }           from './MAP_ICONS_2/Sunset_2.png';
export { default as Tree_At_Snow }       from './MAP_ICONS_2/Tree_At_Snow.png';
export { default as Water }              from './MAP_ICONS_2/Water.png';
